...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
if ((rs1 % 32U) != 0U) {
partInit.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] = *((RV32IMACFD*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] + " + std::to_string(((etiss_int8)((imm) << (2)) >> (2))) + ";\n";
}
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32U) + "U] = " + std::to_string(((etiss_int8)((imm) << (2)) >> (2))) + ";\n";
}
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32U) + "U] = " + std::to_string(((etiss_int32)((imm) << (14)) >> (14))) + ";\n";
}
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
partInit.code() += "if (cpu->return_pending | cpu->exception) return cpu->exception;\n";
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
if (nzuimm) {
partInit.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] = *((RV32IMACFD*)cpu)->X[" + std::to_string(rs1 % 32U) + "U] << " + std::to_string(nzuimm) + "U;\n";
}
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32U) + "U] = (etiss_int32)(res);\n";
}
else {
partInit.code() += "cpu->exception = 0; raise(cpu, system, plugin_pointers, 0U, 2U);\n";
partInit.code() += "goto instr_exit_" + std::to_string(ic.current_address_) + ";\n";
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32U) + "U] = *((RV32IMACFD*)cpu)->X[" + std::to_string(rs2 % 32U) + "U];\n";
}
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->nextPc = " + std::to_string(ic.current_address_ + 2U) + "U;\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32U) + "U] = *((RV32IMACFD*)cpu)->X[" + std::to_string(rd % 32U) + "U] + *((RV32IMACFD*)cpu)->X[" + std::to_string(rs2 % 32U) + "U];\n";
}
partInit.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
partInit.code() += "cpu->instructionPointer = cpu->nextPc;\n";
// -----------------------------------------------------------------------------
