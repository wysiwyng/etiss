...
{
if (csr == 1U) {
return *((RV64IMACFD*)cpu)->CSR[3U] & 31UL;
}
if (csr == 2U) {
return (*((RV64IMACFD*)cpu)->CSR[3U] >> 5UL) & 7U;
}
if (csr == 3072U) {
...
{
if (csr == 1U) {
*((RV64IMACFD*)cpu)->CSR[3] = (*((RV64IMACFD*)cpu)->CSR[3U] & 224UL) | (val & 31UL);
} else if (csr == 2U) {
*((RV64IMACFD*)cpu)->CSR[3] = ((val & 7UL) << 5U) | (*((RV64IMACFD*)cpu)->CSR[3U] & 31UL);
} else if (csr == 3U) {
