...
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32) + "] = " + std::to_string((etiss_int64)(imm)) + ";\n";
}
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4UL) + ";\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32) + "] = " + std::to_string(ic.current_address_ + (etiss_int64)(imm)) + ";\n";
}
// -----------------------------------------------------------------------------
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4UL) + ";\n";
if (imm % 2U) {
partInit.code() += "((RV64IMACFD*)cpu)->exception = raise(cpu, system, plugin_pointers, 0U, 0U);\n";
} else {
if ((rd % 32U) != 0U) {
...
partInit.code() += "cpu->instructionPointer = new_pc & -2L;\n";
partInit.code() += "}\n";
partInit.code() += "return ((RV64IMACFD*)cpu)->exception;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "}\n";
partInit.code() += "if (((RV64IMACFD*)cpu)->exception | cpu->instructionPointer != " + std::to_string(ic.current_address_ + 4) + ") return ((RV64IMACFD*)cpu)->exception;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "((RV64IMACFD*)cpu)->exception |= (*(system->dread))(system->handle, cpu, load_address, (etiss_uint8*)&mem_val_0, 1);\n";
...
partInit.code() += "((RV64IMACFD*)cpu)->exception |= (*(system->dread))(system->handle, cpu, load_address, (etiss_uint8*)&mem_val_0, 2);\n";
...
partInit.code() += "((RV64IMACFD*)cpu)->exception |= (*(system->dread))(system->handle, cpu, load_address, (etiss_uint8*)&mem_val_0, 4);\n";
...
partInit.code() += "((RV64IMACFD*)cpu)->exception |= (*(system->dwrite))(system->handle, cpu, store_address, (etiss_uint8*)&mem_val_0, 1);\n";
...
partInit.code() += "((RV64IMACFD*)cpu)->exception |= (*(system->dwrite))(system->handle, cpu, store_address, (etiss_uint8*)&mem_val_0, 2);\n";
...
partInit.code() += "((RV64IMACFD*)cpu)->exception |= (*(system->dwrite))(system->handle, cpu, store_address, (etiss_uint8*)&mem_val_0, 4);\n";
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4UL) + ";\n";
if ((rd % 32U) != 0U) {
partInit.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32) + "] = ((etiss_uint64)(*((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32U) + "]) < (etiss_uint64)(*((RV64IMACFD*)cpu)->X[" + std::to_string(rs2 % 32U) + "])) ? (1U) : (0U);\n";
}
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4UL) + ";\n";
partInit.code() += "((RV64IMACFD*)cpu)->exception = raise(cpu, system, plugin_pointers, 0U, 11U);\n";
partInit.code() += "return ((RV64IMACFD*)cpu)->exception;\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4UL) + ";\n";
partInit.code() += "((RV64IMACFD*)cpu)->exception = raise(cpu, system, plugin_pointers, 0U, 3U);\n";
partInit.code() += "return ((RV64IMACFD*)cpu)->exception;\n";
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 4UL) + ";\n";
partInit.code() += "((RV64IMACFD*)cpu)->exception = ETISS_RETURNCODE_CPUFINISHED;\n";
partInit.code() += "if (((RV64IMACFD*)cpu)->exception) return ((RV64IMACFD*)cpu)->exception;\n";
// -----------------------------------------------------------------------------
