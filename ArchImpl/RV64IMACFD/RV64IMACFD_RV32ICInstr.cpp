...
partInit.code() += "((RV64IMACFD*)cpu)->exception |= (*(system->dwrite))(system->handle, cpu, load_address, (etiss_uint8*)&mem_val_0, 4);\n";
...
partInit.code() += "}\n";
partInit.code() += "if (cpu->instructionPointer != " + std::to_string(ic.current_address_ + 2) + ") return ((RV64IMACFD*)cpu)->exception;\n";
// -----------------------------------------------------------------------------
...
partInit.code() += "etiss_uint32 mem_val_0;\n";
partInit.code() += "((RV64IMACFD*)cpu)->exception |= (*(system->dread))(system->handle, cpu, offs, (etiss_uint8*)&mem_val_0, 4);\n";
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2UL) + ";\n";
if (rs1) {
partInit.code() += "cpu->instructionPointer = *((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 % 32U) + "] & -2L;\n";
} else {
partInit.code() += "((RV64IMACFD*)cpu)->exception = raise(cpu, system, plugin_pointers, 0U, 2U);\n";
}
partInit.code() += "return ((RV64IMACFD*)cpu)->exception;\n";
...
partInit.code() += "((RV64IMACFD*)cpu)->exception |= (*(system->dwrite))(system->handle, cpu, offs, (etiss_uint8*)&mem_val_0, 4);\n";
