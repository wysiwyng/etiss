...
partInit.code() += "((RV64IMACFD*)cpu)->F[" + std::to_string(rd + 8U) + "] = -4294967296L | res;\n";
...
partInit.code() += "cpu->instructionPointer = " + std::to_string(ic.current_address_ + 2UL) + ";\n";
partInit.code() += "etiss_uint64 offs = *((RV64IMACFD*)cpu)->X[" + std::to_string(rs1 + 8U) + "] + " + std::to_string(uimm) + ";\n";
partInit.code() += "etiss_uint32 mem_val_0 = (etiss_uint32)(((RV64IMACFD*)cpu)->F[" + std::to_string(rs2 + 8U) + "]);\n";
