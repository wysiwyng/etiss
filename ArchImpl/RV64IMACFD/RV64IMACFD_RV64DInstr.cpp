...
{ // block
cp.code() += "etiss_coverage_count(1, 8290);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(10, 8274, 8265, 8264, 8262, 8273, 8270, 8268, 8267, 8271, 8272);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 8277, 8276);\n";
cp.code() += "((RV64IMACFD*)cpu)->FCSR = (((RV64IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 8289, 8278, 8288, 8282, 8279, 8283, 8286, 8284, 8287);\n";
cp.code() += "} // block\n";
} // block
...
{ // block
cp.code() += "etiss_coverage_count(1, 8320);\n";
cp.code() += "{ // block\n";
...
cp.code() += "etiss_coverage_count(10, 8304, 8295, 8294, 8292, 8303, 8300, 8298, 8297, 8301, 8302);\n";
cp.code() += "etiss_uint32 flags = fget_flags();\n";
cp.code() += "etiss_coverage_count(2, 8307, 8306);\n";
cp.code() += "((RV64IMACFD*)cpu)->FCSR = (((RV64IMACFD*)cpu)->FCSR & -32LL) | (flags & 31ULL);\n";
cp.code() += "etiss_coverage_count(9, 8319, 8308, 8318, 8312, 8309, 8313, 8316, 8314, 8317);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
cp.code() += "etiss_coverage_count(7, 8362, 8361, 8358, 8357, 8355, 8359, 8360);\n";
cp.code() += "((RV64IMACFD*)cpu)->F[" + std::to_string(rd) + "ULL] = res;\n";
cp.code() += "etiss_coverage_count(4, 8371, 8369, 8368, 8370);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
{ // block
cp.code() += "etiss_coverage_count(1, 8394);\n";
cp.code() += "{ // block\n";
cp.code() += "*((RV64IMACFD*)cpu)->X[" + std::to_string(rd % 32ULL) + "ULL] = ((RV64IMACFD*)cpu)->F[" + std::to_string(rs1) + "ULL];\n";
cp.code() += "etiss_coverage_count(6, 8393, 8389, 8388, 8386, 8392, 8391);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
...
cp.code() += "etiss_coverage_count(6, 8403, 8397, 8396, 8402, 8401, 8399);\n";
cp.code() += "} // block\n";
} // block
cp.code() += "instr_exit_" + std::to_string(ic.current_address_) + ":\n";
cp.code() += "cpu->instructionPointer = cpu->nextPc;\n";
